package me.dm7.barcodescanner.core.surface;
...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback {
    ...
    @ColorInt
    private int mBorderLineColor = getResources().getColor(R.color.viewfinder_border_line);
    ...
    public BarcodeScannerView(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            mBorderLineColor = a.getColor(R.styleable.BarcodeScannerView_borderLineColor, mBorderLineColor);
    ...
    protected IViewFinder createViewFinderView(Context context) {
        ...
        viewFinderView.setBorderLineColor(mBorderLineColor);
    ...
    public void setBorderLineColor(int borderLineColor) {
        ...
        mViewFinderView.setBorderLineColor(mBorderLineColor);
        mViewFinderView.setupViewFinder();
    }
